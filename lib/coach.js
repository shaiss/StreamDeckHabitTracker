...
// what lands (issue #6).
import { all, getSlots, setSlots, setInsight, getProfile, getSlotHistory, getRoster, setRoster, getNudgeState, setNudgeState, getDismissals } from './store.js';
...
async function gather() {
  const [profile, entries, history, habits, dismissals] = await Promise.all([
