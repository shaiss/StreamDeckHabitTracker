...
export const PROMPTS = {
  ...
  coachPage: (c) =>
    'Assemble your COACH PAGE — the considered layer of your deck: up to 12 habits you are actively ' +
    'tracking or genuinely curious about, the wider bench BEYOND your 4 front slots and the fixed keys. ' +
    'Unlike the front page (what you want RIGHT NOW), these are not urgent — they are the fuller picture of ' +
    'what you are watching. Order them by what matters most; the first ones sit at the top of the page. ' +
    'Lean on your track record: build on habits that land, drop ones that never get tapped. Do NOT repeat a ' +
    'fixed habit or a habit already on your 4 front slots. Fewer strong keys beat twelve weak ones. ' +
