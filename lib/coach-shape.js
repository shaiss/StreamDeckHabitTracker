...
export const PROMPTS = {
  ...
  roster: (c) =>
    ...
    'Context: ' + JSON.stringify(c),
  // The Coach page (#52): the considered layer, up to 12 keys, distinct from
  // the front 4. Not urgent (that is the front page) — the wider set the coach
  // is tracking. Same slot shape as suggest so sanitize()/the deck render reuse.
  coachPage: (c) =>
    'Assemble your COACH PAGE — the considered layer of your deck: the wider board of habits you are ' +
    'tracking or curious about, BEYOND your 4 front slots and the fixed keys. Unlike the front page (what ' +
    'you want RIGHT NOW), these are not urgent — they are the fuller picture of what you are watching. ' +
    'FILL THE PAGE: aim for a full 10-12 keys whenever you have the candidates — this is a board, not a ' +
    'shortlist. Order them by what matters most: your strongest, most-tapped habits at the top, and use the ' +
    'lower slots for lower-confidence experiments worth another look. Lead with what lands; give the ' +
    'long-shots the bottom rows rather than dropping them. Do NOT repeat a fixed habit or a habit already ' +
    'on your 4 front slots. ' +
    'Reply with ONLY JSON: {"slots":[{"habit":"OneWordId","emoji":"🌊","label":"Short","reason":"why it earns a coach-page key"}]}\n\n' +
    'Context: ' + JSON.stringify(c)
};
